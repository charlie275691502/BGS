...
public class Packet{
	...
	Data_Type[] Get_Packet_Slices(){
		switch (command) {
		case Command.C2M_PONG:			return new Data_Type[0];
		case Command.C2M_JOIN:			return new Data_Type[1]{Data_Type.String};
		case Command.C2M_READY:			return new Data_Type[1]{Data_Type.Byte};

		case Command.M2C_PING:			return new Data_Type[0];
		case Command.M2C_PING_VALUE:	return new Data_Type[1]{Data_Type.Short_List};
		case Command.M2C_ROOM:			return new Data_Type[1]{Data_Type.String};
		case Command.M2C_READY:			return new Data_Type[1]{Data_Type.Short_List};
		case Command.M2C_START:			return new Data_Type[0];
		default:
			break;
		}
